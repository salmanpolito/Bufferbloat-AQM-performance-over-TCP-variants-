...
$tcp($id) set timestamps_ true
#$tcp($id) set window_ 10000
$tcp($id) set packetSize_ 1000
 $ns at 0 "$tcp($id) select_ca vegas"
...
$ns at 15 "$tcp($id) set_ca_default_param vegas alpha 40"
$ns at 15 "$tcp($id) set_ca_default_param vegas beta 40"
# confirm the changes by printing the parameter values (optional)
$ns at 15 "$tcp($id) get_ca_default_param vegas alpha"
$ns at 15 "$tcp($id) get_ca_default_param vegas beta"


# change local parameters, only tcp(3) is affected. (optional)
$ns at 30 "$tcp($id) set_ca_param vegas alpha 20"
$ns at 30 "$tcp($id) set_ca_param vegas beta 20"
# confirm the changes by printing the parameter values (optional)
$ns at 30 "$tcp($id) get_ca_param vegas alpha"
$ns at 30 "$tcp($id) get_ca_param vegas beta"
