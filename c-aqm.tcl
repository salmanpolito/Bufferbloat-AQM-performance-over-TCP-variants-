...
$ns duplex-link $node_(r1) $node_(r2) 3Mb 0ms RED 
$ns duplex-link $node_(r2) $node_(r1) 3Mb 0ms RED 
...
$tcp($id) set fid_ 1
$tcp($id) set class_ 1
#$tcp($id) set window_ 20
$tcp($id) set packetSize_ 1000
$ns at 0 "$tcp($id) select_ca cubic"
$ns at 0 "$tcp($id) set_ca_param cubic max_increment 32"
$ns at 0 "$tcp($id) set_ca_param cubic beta 819"
$ns at 0 "$tcp($id) set_ca_param cubic fast_convergence 1"
$ns at 0 "$tcp($id) set_ca_param cubic bic_scale 41"
$ns at 0 "$tcp($id) set_ca_param cubic tcp_friendliness 1"
$ns at 0 "$tcp($id) set_ca_param cubic bic_K 4"
